...
CREATE TABLE `search` (
  `book_title` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO reviews(Username,Book,Author,Review,Stars) VALUES('Ramima','The Kite Runner','Khaled Hosseini','Great Book indeed',2),('Yeamin','Himu','Humayun ahmed','wkwkwkwk',5);
